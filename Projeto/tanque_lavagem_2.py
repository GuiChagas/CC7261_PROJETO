...
def client_handler(client, msg):
    ...
    print("")
    print(f"Saída do tanque de lavagem 2: {tanque_lavagem['solucao']}")
    print(f"Emulsao do tanque de lavagem 2: {tanque_lavagem['emulsao']}") 
...
def main():
    ...
    try:
        server.bind((socket.gethostname(), 50008))
    except:
